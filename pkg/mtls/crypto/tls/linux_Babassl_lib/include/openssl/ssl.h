...
#  define CHACHA_CIPHERSUITES ":TLS_CHACHA20_POLY1305_SHA256"
# else
...
# define TLS_DEFAULT_CIPHERSUITES DEFAULT_CIPHERSUITES \
                                  CHACHA_CIPHERSUITES \
                                  SM4_CIPHERSUITES
...
# define SSL_KEYLESS_TYPE_RSA_DECRYPT                  1
# define SSL_KEYLESS_TYPE_ECC_DECRYPT                  2
# define SSL_KEYLESS_TYPE_ECC_DECRYPT_FORMATED         3
# define SSL_KEYLESS_TYPE_ECDSA_SIGN                   4
# define SSL_KEYLESS_TYPE_RSA_PSS_SIGN                 5
# ifndef OPENSSL_NO_SM2
#  define SSL_KEYLESS_TYPE_SM2_SIGN                    6
# endif
# ifndef OPENSSL_NO_NTLS
#  define SSL_KEYLESS_TYPE_ECC_ENC_DECRYPT             7
#  define SSL_KEYLESS_TYPE_SM2_SIGN_NTLS               8
#  define SSL_KEYLESS_TYPE_SM2DHE_GEN_MASTER_KEY       9
# endif

struct ssl_keyless_st {
    int type;
...
void SSL_set_keyless_callback(SSL *s,
                              int (*keyless_callback)(SSL *ssl, SSL_keyless *param),
                              void *keyless_callback_arg);
void SSL_clr_keyless_callback(SSL *s);
void SSL_set_keyless_result(SSL *s, void *keyless_result,
                            int keyless_result_len);
void SSL_set_keyless_sig_hash(SSL *s, unsigned int sighash);
unsigned int SSL_get_keyless_sig_hash(SSL *s);
void SSL_set_keyless_ec_point(SSL *s, EC_POINT *key);
EC_POINT *SSL_get_keyless_ec_point(SSL *s);
void SSL_set_keyless_rsa_key(SSL *s, RSA *key);
RSA *SSL_get_keyless_rsa_key(SSL *s);
# ifndef OPENSSL_NO_NTLS
void SSL_set_keyless_rsa_sign_key(SSL *s, RSA *key);
RSA *SSL_get_keyless_rsa_sign_key(SSL *s);
void SSL_set_keyless_ec_sign_point(SSL *s, EC_POINT *key);
EC_POINT *SSL_get_keyless_ec_sign_point(SSL *s);
void SSL_set_keyless_ec_enc_point(SSL *s, EC_POINT *key);
EC_POINT *SSL_get_keyless_ec_enc_point(SSL *s);
# endif
int SSL_get_keyless(SSL *s);
RSA *SSL_get_keyless_rsa_pub(SSL *s);
EC_POINT *SSL_get_keyless_ec_pub(SSL *s);
void SSL_set_keyless_rsa_pub(SSL *s, RSA *rsa_pub);
void SSL_set_keyless_ec_pub(SSL *s, EC_POINT *ec_pub);

# define SSL_get_sig_hash BABASSL_get_sig_hash
unsigned int BABASSL_get_sig_hash(SSL *s);

#endif

# ifndef OPENSSL_NO_LURK

#  define OPENSSL_LURK                                    1
#  define SSL_LURK_QUERY_PING                             0
#  define SSL_LURK_QUERY_CAP                              1
#  define SSL_LURK_QUERY_RSA_MASTER                       2
#  define SSL_LURK_QUERY_RSA_EXTEND_MASTER                3
#  define SSL_LURK_QUERY_PFS_RSA_MASTER                   4
#  define SSL_LURK_QUERY_ECDHE                            5
#  define SSL_LURK_QUERY_TYPE_PFS_NON_PREDICTABLE_ECDHE   6
#  define SSL_LURK_QUERY_CERT_VERIFY                      7

# ifndef OPENSSL_NO_SM2
#  define SSL_LURK_QUERY_SM2_SIGN                         8
# endif
# ifndef OPENSSL_NO_NTLS
#  define SSL_LURK_QUERY_ECC_ENC_DECRYPT                  9
#  define SSL_LURK_QUERY_SM2_SIGN_NTLS                    10
#  define SSL_LURK_QUERY_SM2DHE_GEN_MASTER_KEY            11
# endif


#  define SSL_LURK_OK                                     0
#  define SSL_LURK_AGAIN                                  1
#  define SSL_LURK_DONE                                   2
#  define SSL_LURK_ERROR                                  3
...
void SSL_set_lurk_callback(SSL *s,
                           int (*lurk_callback)(SSL *ssl, SSL_lurk *param),
                           void *lurk_callback_arg);
void SSL_clr_lurk_callback(SSL *s);
void SSL_set_lurk_result(SSL *s, void *lurk_result, int lurk_result_len);
long SSL_get_algorithm2(SSL *s);
int SSL_get_lurk_flag(SSL *s);
uint16_t SSL_get_sign_hash_id(SSL *s);
...
#  define SSL_SESS_STAT_WAITING_NONE               0
#  define SSL_SESS_STAT_WAITING_NEW                1
#  define SSL_SESS_STAT_WAITING_GET                2
# endif
...
# endif
# ifndef OPENSSL_NO_GLOBAL_SESSION_CACHE
#  define SSL_SESS_GLOBAL_LOOKUP       9
# endif
# if !(defined(OPENSSL_NO_KEYLESS) && defined(OPENSSL_NO_LURK))
#  define SSL_KEYLESS_CB        10
# endif
...
# endif
# ifndef OPENSSL_NO_GLOBAL_SESSION_CACHE
#  define SSL_want_sess_global_lookup(s)    (SSL_want(s) == SSL_SESS_GLOBAL_LOOKUP)
# endif
# if !(defined(OPENSSL_NO_KEYLESS) && defined(OPENSSL_NO_LURK))
#  define SSL_want_keyless_cb(s)    (SSL_want(s) == SSL_KEYLESS_CB)
# endif
...
#  define SSL_VERIFY_FAIL_IF_SNI_NOT_MATCH_CERT    0x10
# endif
...
# if !(defined(OPENSSL_NO_KEYLESS) && defined(OPENSSL_NO_LURK))
#  define SSL_ERROR_WANT_KEYLESS_RESULT 12
#  define SSL_ERROR_WANT_LURK_RESULT    SSL_ERROR_WANT_KEYLESS_RESULT
# endif

# ifndef OPENSSL_NO_GLOBAL_SESSION_CACHE
#  define SSL_ERROR_WANT_SESSION_RESULT 13
# endif
# ifndef OPENSSL_NO_SESSION_LOOKUP
#  define SSL_ERROR_WANT_SESSION_LOOKUP 14
#  define SSL_ERROR_PENDING_SESSION     14 /* BoringSSL compatibility */
# endif
...
# ifndef OPENSSL_NO_KEYLESS
void SSL_set_cert_callback(SSL *s,
...
#   ifndef OPENSSL_NO_KEYLESS
void SSL_set_keyless_callback_ntls(SSL *s,
                              int (*keyless_callback)(SSL *ssl,
                                                      SSL_keyless *param),
                              void *keyless_callback_arg);
#   endif
#   ifndef OPENSSL_NO_LURK
void SSL_enable_lurk_ntls(SSL *s);
void SSL_disable_lurk_ntls(SSL *s);
#   endif
#  endif
# endif
...
# ifndef OPENSSL_NO_VERIFY_SNI
#  define OPENSSL_VERIFY_SERVER_CERTIFICATE_HOST     1
#  define SSL_CTX_set_verify_server_certificate_host SSL_CTX_set_verify_cert_with_sni
#  define SSL_CTX_get_verify_server_certificate_host SSL_CTX_get_verify_cert_with_sni
#  define SSL_CTX_set_verify_sni SSL_CTX_set_verify_cert_with_sni
#  define SSL_CTX_get_verify_sni SSL_CTX_get_verify_cert_with_sni
...
# ifndef OPENSSL_NO_GLOBAL_SESSION_CACHE
void SSL_set_global_session_result(SSL *s, SSL_SESSION *result);
# endif

# ifndef OPENSSL_NO_SESSION_REUSED_TYPE
#  define SSL_SESSION_REUSED_TYPE_NOCACHE                  0
#  define SSL_SESSION_REUSED_TYPE_CACHE                    1
#  define SSL_SESSION_REUSED_TYPE_TICKET                   2
...
#  define OPENSSL_CIPHERS_CHANGEABLE 1
#  define OPENSSL_CIPHERS_DUP        1

int SSL_set_ciphers(SSL *s, STACK_OF(SSL_CIPHER) *cipher_list);
int SSL_set_ciphers_by_id(SSL *s, STACK_OF(SSL_CIPHER) *cipher_list_by_id);

STACK_OF(SSL_CIPHER) *SSL_dup_ciphers(SSL *s);
STACK_OF(SSL_CIPHER) *SSL_dup_ciphers_by_id(SSL *s);

int SSL_CTX_set_ciphers(SSL_CTX *ctx, STACK_OF(SSL_CIPHER) *cipher_list);

STACK_OF(SSL_CIPHER) *SSL_CTX_get_ciphers_by_id(const SSL_CTX *ctx);
int SSL_CTX_set_ciphers_by_id(SSL_CTX *ctx,
                              STACK_OF(SSL_CIPHER) *cipher_list_by_id);
# endif

# ifndef OPENSSL_NO_STATUS
#  define OPENSSL_STATUS_ENABLE           1
/*SSL handshake status*/
#  define SSL_CLIENT_RPOTOCOL             0
#  define SSL_CLIENT_CIPHER               1
#  define SSL_CLIENT_V2_CIPHER            2
#  define SSL_SERVER_EXCHANGE_PUBKEY      3
#  define SSL_CLIENT_RSA_EXCHANGE         4
#  define SSL_SERVER_DH_PUBKEY            5
#  define SSL_CLIENT_SESSION_ID           6
#  define SSL_CLIENT_ECC_CURVES           7

struct ssl_status_st {
    void          *arg;
    void          *parg;
    int            type;
    int            ssl_status_enable;
};
...
int SSL_get_desc_and_level(SSL *s, int *level, int *desc);
int (*SSL_get_status_callback(const SSL *s)) (unsigned char *p,
                                              unsigned int length,
                                              SSL_status *param);
# endif

# ifndef OPENSSL_NO_REQ_STATUS
#  define OPENSSL_REQ_STATUS_ENABLE                       1
#  define SSL_STATUS_TYPE_TIME                            0
#  define SSL_STATUS_TYPE_ERROR                           1
#  define SSL_STATUS_TYPE_KEYLESS_ERROR                   2
#  define SSL_STATUS_TYPE_LURK_ERROR                      3
#  define SSL_STATUS_TYPE_CLIENT_SESSION_ID               4

#  define SSL_STATUS_PHASE_CLIENT_HELLO                   0
#  define SSL_STATUS_PHASE_SERVER_HELLO                   1
#  define SSL_STATUS_PHASE_CERTIFICATE                    2
#  define SSL_STATUS_PHASE_SERVER_KEY_EXCHANGE            3
#  define SSL_STATUS_PHASE_SERVER_HELLO_DONE              4
#  define SSL_STATUS_PHASE_CLIENT_KEY_EXCHANGE            5
#  define SSL_STATUS_PHASE_CLIENT_CHANGE_CIPHER_SPEC      6
#  define SSL_STATUS_PHASE_CLIENT_NEXT_PROTO              7
#  define SSL_STATUS_PHASE_CLIENT_FINISHED                8
#  define SSL_STATUS_PHASE_NEW_SESSION_TICKET             9
#  define SSL_STATUS_PHASE_SERVER_CHANGE_CIPHER_SPEC      10
#  define SSL_STATUS_PHASE_SERVER_FINISHED                11
#  define SSL_STATUS_PHASE_APPLICATION_DATA               12
#  define SSL_STATUS_PHASE_APPLICATION_H1                 13
#  define SSL_STATUS_PHASE_APPLICATION_H2                 14
#  define SSL_STATUS_PHASE_APPLICATION_SPDY               15
#  define SSL_STATUS_PHASE_DYCERT                         16
#  define SSL_STATUS_PHASE_DYLURK                         17
#  define SSL_STATUS_PHASE_LURK                           18
#  define SSL_STATUS_PHASE_KEYLESS                        19
#  define SSL_STATUS_PHASE_HANDSHAKE                      20
#  define SSL_STATUS_PHASE_OTHER                          21
#  define SSL_STATUS_PHASE_HANDSHAKE_SW_BGN               22
#  define SSL_STATUS_PHASE_HANDSHAKE_SW_END               23
#  define SSL_STATUS_PHASE_HANDSHAKE_SR_BGN               24
#  define SSL_STATUS_PHASE_HANDSHAKE_SR_END               25

#  define SSL_STATUS_ERROR_NONE                           0
#  define SSL_STATUS_ERROR_NO_SNI                         1
#  define SSL_STATUS_ERROR_GET_CERTIFICATE_FAILED         2
#  define SSL_STATUS_ERROR_NO_CERTIFICATE                 3
#  define SSL_STATUS_ERROR_CERTIFICATE_EXPIRED            4
#  define SSL_STATUS_ERROR_CERTIFICATE_EXPIRE_SOON        5
#  define SSL_STATUS_ERROR_CERTIFICATE_SNI_MISMATCH       6
#  define SSL_STATUS_ERROR_CERTIFICATE_PRIVATE_MISMATCH   7
#  define SSL_STATUS_ERROR_CERTIFICATE_FORMAT_ERROR       8
#  define SSL_STATUS_ERROR_PRIVATE_FORMAT_ERROR           9
#  define SSL_STATUS_ERROR_VERSION_MISMATCH               10
#  define SSL_STATUS_ERROR_CIPHER_MISMATCH                11
#  define SSL_STATUS_ERROR_PROTOCOL_ERROR                 12
#  define SSL_STATUS_ERROR_INTERNAL_ERROR                 13
#  define SSL_STATUS_ERROR_DECRYPTE_ERROR                 14
#  define SSL_STATUS_ERROR_SIGN_ERROR                     15
#  define SSL_STATUS_ERROR_DECODE_ERROR                   16
#  define SSL_STATUS_ERROR_SERVER_ALERT                   17
#  define SSL_STATUS_ERROR_CLIENT_ALERT                   18
#  define SSL_STATUS_ERROR_PEER_CLOSED                    19
#  define SSL_STATUS_ERROR_IP_SNI                         20

void SSL_set_req_status_callback(SSL *s,
                                 void (*status_callback)(SSL *s, int type,
                                                         int phase, int error,
                                                         void *param),
                                 void *param);
void (*SSL_get_req_status_callback(const SSL *s))(SSL *s, int type, int phase,
                                                  int error, void *param);
# endif
